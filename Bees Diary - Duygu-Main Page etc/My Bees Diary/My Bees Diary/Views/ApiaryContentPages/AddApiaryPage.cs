...
namespace My_Bees_Diary.Views
{
    public class AddApiaryPage : ContentPage
    {
        ...
        private List<AreaPlants> areaPlants;
        private Button add;
        private Button exit;
        ...
        public AddApiaryPage(string dbPath)
        {
            ...
            areaPlants = new List<AreaPlants>();
            ...
            if (checkBox1.IsChecked)
            {
                ...
                {
                    PlantsID = id,
                    PlantsList = plantsInArea.ToList()
                };
